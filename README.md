...
<p align="center">YacineROM Kebab is a work-in-progress custom firmware for Samsung Galaxy devices.</p>

# What is YacineROM Kebab?
YacineROM Kebab is a work-in-progress custom firmware for Samsung Galaxy devices based on ExtremeROM-Kebab. It's based on the latest and greatest iteration of Samsung's UX and it also includes additional features and tweaks to ensure the best possible experience out of the box.
...
YacineROM Kebab will support the S20 series running an Snapdragon 8250 SoC
...
# Bugs
See the <a href="https://github.com/Yacinegti-DZ/ExtremeROM-Kebab/issues">⚠ Issues</a> tab
...
- **[Oskar](https://github.com/osrott61-gh)** - For the ExtremeROM Kebab for snapdragon
- more to come
...
[![Stargazers over time](https://starchart.cc/Yacinegti-DZ/ExtremeROM-Kebab.svg)](https://starchart.cc/Yacinegti-DZ/ExtremeROM-Kebab)
